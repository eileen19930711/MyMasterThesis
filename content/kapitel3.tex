...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{Simu_3D_1.png} %%% 換，字重疊。
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{4_Test_3D.png} %%% 換，字重疊、圖例太右下。
  \caption{\small The reconstructed line segments and the unrefined DSM profile in UTM coordinate system (in Zone 32N).}
  \label{fig:Test3D_1}
  \vspace{1cm}
  \includegraphics[width=\textwidth]{4_Test_hist.png} %%% 換，字太小、增加xtick。

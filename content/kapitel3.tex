...
\begin{figure}%[!h]
  \centering
  \subfloat[]{\includegraphics[height=0.48\textwidth]{FlightTrajectory5.png} \label{fig:trajectory1}}
  \subfloat[]{\includegraphics[height=0.48\textwidth, trim=220 0 0 0,clip]{FlightTrajectory3.png} \label{fig:trajectory2}}

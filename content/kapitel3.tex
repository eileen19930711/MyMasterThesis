...
The distances from reconstructed line nodes to the true line segment are collected, resulting in sample size of 9. The sample mean is $-0.004$ [meter] and the sample standard deviation is $0.012$ [meter]. This sampling procedure is assumed to be independent and random.%???

%In order to claim that the reconstructed line segments are close enough to the true line segments, %i.e. distances between them have mean value $0$,

...
\cref{fig:SimuImgNum_1} gives the information on the amount of covering images, the redundancies and the adjusted height of the reconstructed line nodes in each segment, i.e. each independent LS adjustment.

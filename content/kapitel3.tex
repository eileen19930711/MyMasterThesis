...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.8\textwidth]{Reconstructed_BeforeandAfter0.png}}
	
	\subfloat[\small Zoom in to show the difference between the original DSM profiles and the reconstructed lines.]{\includegraphics[width=0.8\textwidth]{Reconstruction_zoom2.png}}

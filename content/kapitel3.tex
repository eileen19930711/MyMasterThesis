...
\cref{fig:Simu3D_2} shows the reconstructed and the true line segments in UTM coordinate system (in Zone 32 ??). The distances from the reconstructed line segment to the true one are plotted into histogram in \cref{fig:SimuHist_2}. They are collected along the reconstructed line with 20 centimeter spacing.

The mean value of the differences is zero (statistical test).

...
\begin{figure}%[!h]
  ...
  \centering
  \includegraphics[width=0.45\textwidth, trim={180 0 120 0},clip=true]{DEM_A9_FINAL_PART_small_shaded.png}
  ...
  \parbox{.475\linewidth}{
  \centering
  \includegraphics[width=0.45\textwidth, trim={100 0 120 0},clip=true]{DEM_A9_STD_small_terrain.png}

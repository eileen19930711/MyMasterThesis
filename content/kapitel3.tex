...
\cref{fig:SimuImgNum_1} gives the information on the amount of covering images, the redundancies and the height value of the reconstructed nodes of each segment, i.e. of each independent LS adjustment process.

\cref{fig:SimuError} shows the mean and variance of the added random Gaussian noise and the adjusted residuals. 

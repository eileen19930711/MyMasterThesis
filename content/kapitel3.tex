...
\cref{sec:Materials} provides information about input dataset and some applied preprocessing steps. 
...
to slightly suppress the noise in images. The extracted lines of length less than 30 pixels are rejected % why
regarding the fact that a dashed lane-line is no longer than 6 meter which is correspondingly 100 pixels considering the GSD of 6.9 cm.

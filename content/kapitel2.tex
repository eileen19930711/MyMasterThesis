...
Let the unknown image coordinates of the endpoints of a line be $(x_1,y_1)$ and $(x_2,y_2)$, and the inconsistent observations $\{x_i,y_i\}^n_{i=1}$. The observation equations \eqref{eq:MixModel1-1} and \eqref{eq:MixModel1-2} of the mixed model now take the form: 

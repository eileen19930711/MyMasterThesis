...
\begin{itemize}
      ...
      \item caused by inaccurate camera attitude: $\sqrt{\sigma_{Roll}^2+\sigma_{Pitch}^2}\times H_{flight height}\approx0.020$ [m]
      \item caused by inaccurate IOs: $1_{[pixel]}\times GSD\div\cos^2(oblique\ angle)\approx0.074$ [m]
\end{itemize}
and arond ??? [cm] in Z-direction:
\begin{itemize}
      \item caused by inaccurate camera position: $\sigma_{altitude}\approx0.060$ [m]
      \item caused by inaccurate camera attitude: $\sqrt{\sigma_{Roll}^2+\sigma_{Pitch}^2}\times H_{flight height}\approx0.020$ [m]
      \item caused by inaccurate IOs: $1_{[pixel]}\times GSD\times\dfrac{\sin(oblique\ angle)}{\cos(oblique\ angle)}\approx0.018$ [m]
\end{itemize}

...
\begin{bmatrix}
\mathcal{H}^y(q^1,P_s,P_e,n^1_{l,1,x})\\[0.3em]
\mathcal{H}^y(q^1,P_s,P_e,n^1_{l,2,x})\\[0.3em]
...\\[0.3em]
\mathcal{H}^y(q^1,P_s,P_e,n^1_{l,N^1,x})\\[0.5em]
\mathcal{H}^x(q^1,P_s,P_e,n^1_{l,1,x})\\[0.3em]
\mathcal{H}^x(q^1,P_s,P_e,n^1_{l,2,x})\\[0.3em]
...\\[0.3em]
\mathcal{H}^x(q^1,P_s,P_e,n^1_{l,N^1,x})
\end{bmatrix}
\end{equation}
...
Function $\mathcal{H}$ actually do line fitting in all covering image spaces where the lines to be fitted come from single 3D line segment. 

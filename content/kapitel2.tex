...
\begin{itemize}
      \item caused by inaccurate position of the perspective center: $\sqrt{\sigma_{north}^2+\sigma_{east}^2}\approx0.058$ [m]
      \item caused by inaccurate orientation of the image: $\sqrt{\sigma_{Roll}^2+\sigma_{Pitch}^2}\times H_{flight height}\approx0.020$ [m]

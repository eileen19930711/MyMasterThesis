...
The interior and exterior camera parameters are refined by bundle adjustment.
accuracy:
Additional parameters for lens distortion are also calibrated.

We can further derive the undistorted images with the calibrated lens distortion parameters.
...
With the interior and exterior iamge orientations, the original image can be reprojected on DSM model to generate orthorectified image. 

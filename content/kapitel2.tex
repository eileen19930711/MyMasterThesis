...
\begin{figure}%[!h]
  \centering
  \subfloat[Part of the DSM in road area. It is noisy in the center of motorway.]{\includegraphics[width=0.5\textwidth]{DEM_A9_FINAL_PART_small_shaded.png} \label{fig:DSM}}
  \subfloat[Standard deviations of the height value of the DSM in road area. It is higher in the center of motorway.]{\includegraphics[width=0.5\textwidth]{DEM_A9_STD_small_terrain.png} \label{fig:DSMstd}}
...
%\begin{figure}%[!h]
  \centering
  \includegraphics[width=0.34\textwidth]{DEM_A9_NUM_scaled_s.png}

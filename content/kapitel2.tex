...
\begin{figure}[!h]
  \centering
  \subfloat[]{\includegraphics[width=0.3\textwidth]{FlightTrajectory5.png} \label{fig:trajectory1}}
  \subfloat[]{\includegraphics[width=0.4\textwidth]{FlightTrajectory3.png} \label{fig:trajectory2}}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{OL1234.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{ML1234.png}

...
\begin{figure}
\centering
\subfloat[\small Continuous line]{\fbox{\includegraphics[width=0.3\textwidth, trim=0 100 0 100,clip]{Laengsmarkierung_durchgehend.pdf}}}
\quad
\subfloat[\small Dashed line]{\fbox{\includegraphics[width=0.3\textwidth, trim=0 100 0 100,clip]{Laengsmarkierung_unterbrochen.pdf}}}
\newline
\subfloat[\small Continuous and dashed double lines]{\fbox{\includegraphics[width=0.3\textwidth, trim=0 100 0 100,clip]{Laengsmarkierung_unterbrochen_durchgehend.pdf}}}
\quad
\subfloat[\small Continuous double lines]{\fbox{\includegraphics[width=0.3\textwidth, trim=0 100 0 100,clip]{Laengsmarkierung_durchgehend_doppelt.pdf}}}
\quad
\subfloat[\small Dashed double lines]{\fbox{\includegraphics[width=0.3\textwidth, trim=0 100 0 100,clip]{Laengsmarkierung_unterbrochen_doppelt.pdf}}}
% Pre-warning line

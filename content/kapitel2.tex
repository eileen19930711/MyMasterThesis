...
The DSM has 20 cm grid spacing. \cref{fig:DSMnumber} shows the distribution of stereo pairs used for DSM generation.

\begin{figure}%[!h]
  \centering
  \subfloat[Standard Deviation]{\includegraphics[height=0.8\textwidth]{DEM_A9_NUM_scaled_s.png} \label{fig:DSMstd}}
  \subfloat[Distribution of stereo pairs. Lighter color indicates more stereo pairs are used for DSM generation in that area. The maximum number of stereo pairs used in this DSM is 27.]{\includegraphics[width=0.4\textwidth]{DEM_A9_NUM_scaled_s.png} \label{fig:DSMnumber}}
  \caption{DSM information}
  \label{fig:DSM}
\end{figure}

...
\begin{figure}[!h]
  \centering
  \subfloat[]{\includegraphics[width=0.5\textwidth]{FlightTrajectory1.png} \label{fig:trajectory1}}%5
  %\subfloat[]{\includegraphics[width=0.5\textwidth]{FlightTrajectory3.png} \label{fig:trajectory2}}%3

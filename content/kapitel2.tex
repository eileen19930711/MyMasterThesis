...
\begin{figure}[!h]
  \centering
  \subfloat[]{\includegraphics[width=0.5\textwidth]{FlightTrajectory1.png} \label{fig:trajectory1}}
  \subfloat[]{\includegraphics[width=0.5\textwidth]{FlightTrajectory2.png} \label{fig:trajectory2}}

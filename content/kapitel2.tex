...
The DSM has 0.2 m grid spacing. \cref{fig:DSMnumber} shows the image coverage on the DSM

\begin{figure}%[!h]
  \centering
  \subfloat[]{\includegraphics[height=0.45\textwidth]{DEM_A9_NUM_scaled.png} \label{fig:DSMstd}}
  \subfloat[]{\includegraphics[height=0.45\textwidth]{DEM_A9_NUM_scaled.png} \label{fig:DSMnumber}}

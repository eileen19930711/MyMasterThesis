...
In the structure of the Gauss-Markov model, for all covering image $j=1,2,...J$, there are $2\times\displaystyle\sum_{j=1}^{J}N^j$ observation equations:
...
=
\begin{bmatrix}
 \mathcal{H}^x(\mathbf{q}^1,\mathbf{P}_s,\mathbf{P}_e,y^1_1)\\[0.3em]
 \vdots\\
 \mathcal{H}^x(\mathbf{q}^1,\mathbf{P}_s,\mathbf{P}_e,y^1_{N^1})\\[0.3em]
 \arrayrulecolor{gray} \hline
 \mathcal{H}^y(\mathbf{q}^1,\mathbf{P}_s,\mathbf{P}_e,y^1_1)\\[0.3em]
 \vdots\\
 \mathcal{H}^y(\mathbf{q}^1,\mathbf{P}_s,\mathbf{P}_e,y^1_{N^1})\\[0.3em]
 \arrayrulecolor{gray} \hline
 \vdots\\
 \arrayrulecolor{gray} \hline
 \mathcal{H}^x(\mathbf{q}^J,\mathbf{P}_s,\mathbf{P}_e,y^J_1)\\[0.3em]
 \vdots\\
 \mathcal{H}^x(\mathbf{q}^J,\mathbf{P}_s,\mathbf{P}_e,y^J_{N^J})\\[0.3em]
 \arrayrulecolor{gray} \hline
 \mathcal{H}^y(\mathbf{q}^J,\mathbf{P}_s,\mathbf{P}_e,y^J_1)\\[0.3em]
 \vdots\\
 \mathcal{H}^y(\mathbf{q}^J,\mathbf{P}_s,\mathbf{P}_e,y^J_{N^J})\\[0.3em]
\end{bmatrix}
\begin{array}{@{\kern-\nulldelimiterspace}l@{}}
 \left.\begin{array}{@{}c@{}}\\ \\ \\ \\ \\ \\[10pt] \end{array}\right\}2\times N^1\\
 \left.\begin{array}{@{}c@{}}\\                     \end{array}\right. \vdots     \\
 \left.\begin{array}{@{}c@{}}\\ \\ \\ \\ \\ \\[10pt] \end{array}\right\}2\times N^J\\
\end{array}
\end{equation}
\clearpage
...
The constraint equations \eqref{eq:constraint1}, \eqref{eq:constraint2} and \eqref{eq:constraint3} can be stacked together and have the vector form:

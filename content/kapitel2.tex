...
\begin{figure} [h!]
	\centering
	\subfloat[Before optimization]{\includegraphics[width=0.8\textwidth]{2-4_1_1.png} \label{fig:beforeoptimization}}
	
	\subfloat[After optimization]{\includegraphics[width=0.8\textwidth]{2-4_1_2.png} \label{fig:afteroptimization}}

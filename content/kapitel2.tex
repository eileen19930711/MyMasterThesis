...
\end{bmatrix}
\end{equation}
which depends on both the design matrix $\mathsf{A}$ (i.e. the configuration) and the posterior standard deviation of unit weight $\hat{\sigma}_0$ (i.e. the posterior measurements quality).

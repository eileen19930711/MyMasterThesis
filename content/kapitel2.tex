...
The low-oblique aerial images used in this work are acquired from Canon EOS 1D-X, one of the non-metric cameras in 4k system, with an oblique viewing angle of 15$\degree$.
...
\begin{figure}[!h]
  \parbox{.3\linewidth}{
    \centering
    \includegraphics[width=0.3\textwidth]{L1234_rsz.png}
...
\subsection{Non-linear Least-Squares Adjustment}

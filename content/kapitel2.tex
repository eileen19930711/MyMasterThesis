...
\begin{figure}[!h]
  \centering
  \subfloat[]{\includegraphics[height=0.4\textwidth]{FlightTrajectory5.png} \label{fig:trajectory1}}
  \subfloat[]{\includegraphics[height=0.4\textwidth]{FlightTrajectory3.png} \label{fig:trajectory2}}
...
\begin{figure}
  \parbox{.3\linewidth}{
    \centering
    \includegraphics[width=0.3\textwidth]{OL1234_rsz.png}
  ...
  \parbox{.3\linewidth}{
    \centering
    \includegraphics[width=0.3\textwidth]{ML1234_rsz.png}
...
Firstly, OSM data is written into orthorectified images. Road regions are then extracted with 20 meter buffer width around road axes. By back-projecting the mask from orthorectified image to original image, it can then be used to mask out the road regions on the original images.

...
Let the two endpoints of a line segment in object space be: a start-point $(X_1,Y_1,Z_1)$ and an end-point $(X_2,Y_2,Z_2)$. 
...
Two constraints are needed to fix rank defect in A matrix, they are set to be:
\begin{itemize}
\item The object coordinates of the start-point
\end{itemize}

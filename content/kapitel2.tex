...
A linear regression model describes a dependent variable as a function of the regressor (an independent variable). In the case when both dependent variable $x$ and regressor $y$ are measured with errors $e_x$ and $e_y$, a linear regression model takes the form:

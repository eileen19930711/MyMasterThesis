...
%  \parbox{.3\linewidth}{
    \centering
    \includegraphics[width=0.45\textwidth]{ML1234_rsz.png}
...
The $\sigma$ value for Gaussian smoothing is set to be 1.8 in this work to slightly suppress the noise. Each extracted line is rasterized as a set of points with sub-pixel precision in image space.

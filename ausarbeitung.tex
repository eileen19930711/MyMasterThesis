...
\section*{Abstract}
\fi
With the development of autonomous driving, 3D lane marking ....


The proposed approach exploits the use of linear regression in image space for 3D lane markings reconstruction.

Lane markings are automatically extracted from aerial images and 
 
 
despite their poorly textured neighborhoods



Though the approach requires initial approximations and highly depends on known image orientations, it is robust to partial occlusion and is applicable in lowly textured neighberings cases. The approach is developed for both dashed and continuous lane lines.

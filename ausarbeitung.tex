...
\fi
\ldots
This paper exploits the use of linear regression in image space for 3D line reconstruction. [… will be finished after finishing all the chapters]
...
\else
All links were last followed on December 22, 2017.
\fi

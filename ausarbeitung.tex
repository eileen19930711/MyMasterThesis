...
Experimental results are given for both continuous and dashed lane lines.??? The evaluation shows the achieved reconstruction accuracy of centimeter level with the used materials.???

\vspace{3cm}

keywords: 3D line reconstruction, linear regression, least-squares adjustment
\cleardoublepage

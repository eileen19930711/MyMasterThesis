...
This thesis presents a framework for 3D lane markings reconstruction without explicit feature matching process. The aim is to optimize the best 3D line location by minimizing the distance from its back projection to the detected 2D line in all the covering images.
